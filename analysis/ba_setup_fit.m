function fout = ba_setup_fit(Nmodes, weights, startpoint)
...
%
    ...
    opts = setup_fitoptions('lsqnonlin', [], pstart, lb, ub);
...
% OPTIMOPTIONS
function opts = setup_fitoptions(method, weights, startpoint, lb, ub)
